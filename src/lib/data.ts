...
export const DEFAULT_CATEGORY_SETTINGS: Record<string, CategorySettings> = {
  quote:     { categoryId:'quote',     pointsCorrect:15, pointsWrong:-5,  stealPoints:10, answerTimeSecs:30, stealTimeSecs:10, hotSeatTimeSecs:60 },
  general:   { categoryId:'general',   pointsCorrect:10, pointsWrong:-3,  stealPoints:7,  answerTimeSecs:30, stealTimeSecs:10, hotSeatTimeSecs:60 },
  character: { categoryId:'character', pointsCorrect:10, pointsWrong:-3,  stealPoints:7,  answerTimeSecs:30, stealTimeSecs:10, hotSeatTimeSecs:60 },
  hotseat:   { categoryId:'hotseat',   pointsCorrect:5,  pointsWrong:0,   stealPoints:0,  answerTimeSecs:30, stealTimeSecs:10, hotSeatTimeSecs:60 },
  openverse: { categoryId:'openverse', pointsCorrect:20, pointsWrong:-10, stealPoints:15, answerTimeSecs:45, stealTimeSecs:15, hotSeatTimeSecs:60 },
  truefalse: { categoryId:'truefalse', pointsCorrect:8,  pointsWrong:-4,  stealPoints:0,  answerTimeSecs:20, stealTimeSecs:10, hotSeatTimeSecs:60 },
}

export const SEED_QUESTIONS: Question[] = [
  { id:'q_qt_e1', categoryId:'quote', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'Complete: "For God so loved the world that He gave His only begotten Son, that whoever believes in Him shall not perish but..."', answer:'have eternal life (John 3:16)', quoteFields:{verseRef:'John 3:16',partialVerse:'For God so loved the world that He gave His only begotten Son, that whoever believes in Him shall not perish but...',completion:'have eternal life'} },
  { id:'q_qt_e2', categoryId:'quote', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'Complete: "The LORD is my shepherd; I shall not..."', answer:'want (Psalm 23:1)', quoteFields:{verseRef:'Psalm 23:1',partialVerse:'The LORD is my shepherd; I shall not...',completion:'want'} },
  { id:'q_qt_e3', categoryId:'quote', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'Complete: "Be still and know that I am..."', answer:'God (Psalm 46:10)', quoteFields:{verseRef:'Psalm 46:10',partialVerse:'Be still and know that I am...',completion:'God'} },
  { id:'q_qt_m1', categoryId:'quote', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'Complete: "Trust in the LORD with all your heart and lean not on your own..."', answer:'understanding (Proverbs 3:5)', quoteFields:{verseRef:'Proverbs 3:5',partialVerse:'Trust in the LORD with all your heart and lean not on your own...',completion:'understanding'} },
  { id:'q_qt_m2', categoryId:'quote', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'Complete: "I can do all things through Christ who..."', answer:'strengthens me (Philippians 4:13)', quoteFields:{verseRef:'Philippians 4:13',partialVerse:'I can do all things through Christ who...',completion:'strengthens me'} },
  { id:'q_qt_h1', categoryId:'quote', difficulty:'hard',   source:'seed', createdAt:0, updatedAt:0, question:'Complete: "But seek first the kingdom of God and His righteousness, and all these things shall be..."', answer:'added to you (Matthew 6:33)', quoteFields:{verseRef:'Matthew 6:33',partialVerse:'But seek first the kingdom of God and His righteousness, and all these things shall be...',completion:'added to you'} },
  { id:'q_qt_h2', categoryId:'quote', difficulty:'hard',   source:'seed', createdAt:0, updatedAt:0, question:'Complete: "For the wages of sin is death, but the gift of God is..."', answer:'eternal life in Christ Jesus our Lord (Romans 6:23)', quoteFields:{verseRef:'Romans 6:23',partialVerse:'For the wages of sin is death, but the gift of God is...',completion:'eternal life in Christ Jesus our Lord'} },

  { id:'q_gk_e1', categoryId:'general', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'How many books are in the Bible?', answer:'66 books (39 Old Testament, 27 New Testament)' },
  { id:'q_gk_e2', categoryId:'general', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'Who built the ark?', answer:'Noah' },
  { id:'q_gk_e3', categoryId:'general', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'What is the first book of the Bible?', answer:'Genesis' },
  { id:'q_gk_m1', categoryId:'general', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'What are the first five books of the Bible called?', answer:'The Pentateuch / Torah' },
  { id:'q_gk_m2', categoryId:'general', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'Who was swallowed by a great fish?', answer:'Jonah' },
  { id:'q_gk_m3', categoryId:'general', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'How many plagues were sent upon Egypt?', answer:'10 plagues' },
  { id:'q_gk_h1', categoryId:'general', difficulty:'hard',   source:'seed', createdAt:0, updatedAt:0, question:'What is the last book of the Old Testament?', answer:'Malachi' },
  { id:'q_gk_h2', categoryId:'general', difficulty:'hard',   source:'seed', createdAt:0, updatedAt:0, question:'Who was the first Christian martyr mentioned in the New Testament?', answer:'Stephen (Acts 7)' },
  { id:'q_gk_h3', categoryId:'general', difficulty:'hard',   source:'seed', createdAt:0, updatedAt:0, question:'Which river was Jesus baptised in?', answer:'The Jordan River' },

  { id:'q_ch_e1', categoryId:'character', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'I was a shepherd boy who defeated a giant named Goliath with a sling and a stone. Who am I?', answer:'David' },
  { id:'q_ch_e2', categoryId:'character', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'I was placed in a basket and floated down the Nile River as a baby. Who am I?', answer:'Moses' },
  { id:'q_ch_e3', categoryId:'character', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'I betrayed Jesus for 30 pieces of silver. Who am I?', answer:'Judas Iscariot' },
  { id:'q_ch_m1', categoryId:'character', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'I was a tax collector who climbed a sycamore tree to see Jesus. Who am I?', answer:'Zacchaeus' },
  { id:'q_ch_m2', categoryId:'character', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'I interpreted Pharaoh\'s dream and became second in command of Egypt. Who am I?', answer:'Joseph' },
  { id:'q_ch_m3', categoryId:'character', difficulty:'medium', source:'seed', createdAt:0, updatedAt:0, question:'I denied Jesus three times before the rooster crowed. Who am I?', answer:'Peter (Simon Peter)' },
  { id:'q_ch_h1', categoryId:'character', difficulty:'hard',   source:'seed', createdAt:0, updatedAt:0, question:'I was a judge of Israel whose great strength came from my uncut hair. Who am I?', answer:'Samson' },
  { id:'q_ch_h2', categoryId:'character', difficulty:'hard',   source:'seed', createdAt:0, updatedAt:0, question:'I was struck blind on the road to Damascus and later became a great apostle. Who am I?', answer:'Paul (Saul of Tarsus)' },

  { id:'q_hs_e1', categoryId:'hotseat', difficulty:'easy',   source:'seed', createdAt:0, updatedAt:0, question:'Name as many of the 12 disciples of Jesus as you can!', answer:'Peter, Andrew, James, John, Philip, Bartholomew, Matthew, Thomas, James (Alphaeus), Thaddaeus, Simon the Zealot, Judas Iscariot', hotSeatFields:{challenge:'Name as many of the 12 disciples of Jesus as you can!',acceptableAnswers:['Peter','Andrew','James','John','Philip','Bartholomew','Matthew','Thomas','Thaddaeus','Simon','Judas']} },
