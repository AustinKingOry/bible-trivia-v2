...
export function dbToQuestion(row: DbQuestion): Question {
  return {
    ...
    quoteFields:   row.quote_fields    as Question['quoteFields']    ?? undefined,
    openVerseFields: row.open_verse_fields as Question['openVerseFields'] ?? undefined,
    trueFalseFields: row.true_false_fields as Question['trueFalseFields'] ?? undefined,
    hotSeatFields: row.hot_seat_fields as Question['hotSeatFields'] ?? undefined,
